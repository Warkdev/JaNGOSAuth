 ...
 * @version v0.1 BETA.
 */
public abstract class AbstractAuthClientPacket {
    protected AuthClientCmd opcode;
    
    public AbstractAuthClientPacket(final AuthClientCmd opcode){
        this.opcode = opcode;
    }
    
    public AuthClientCmd getOpcode(){
        return this.opcode;
    }
