...
/**
 * AccountService is the controller for account management. It allows to manager
 * back-end database transparently as well as ensuring business rules such as
 * failed login attempt. It handles the application logic.
 *
 * @author Warkdev
 * @version v0.1 BETA.
 */
public class AccountService {
    ...
    public boolean login(Account account, String ip, String locale, String session) {
        ...
        if (ip == null || !AuthUtils.isValidIP4Address(ip)) {
